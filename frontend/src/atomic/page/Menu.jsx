...
const handleClickSort = (valueSort)=>{
    ...
    // setSearchParams(searchParams)
      ...
      const refMap = {
    'coffee-series': coffeeRef,
    'non-coffee-series': nonCoffeeRef,
    'frappe-series': frappeRef,
  }

  ///animation/

  const targetRef = refMap[valueSort];

  if (targetRef){

     gsap.to(window, {
      duration: 0.5,
      scrollTo: { y: targetRef.current,offsetY : 230},
      ease: 'power2.inOut',
    })
  ...
  return (
    ...
    <div className=' flex justify-center gap-3 pt-[7%] bg-[#F3E8D7]'>
