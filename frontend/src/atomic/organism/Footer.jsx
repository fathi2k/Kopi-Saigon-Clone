...
const Footer = () => {
  return (
    <>
    <div className='bg-kopi-saigon text-amber-800 flex flex-col gap-[45px] h-[291px] justify-center  absolute right-0 left-0'>


  <div className=' flex justify-around '>
          <img className='h-[136px] w-[115px]' src="/image/footer/logo.svg" alt="" />
